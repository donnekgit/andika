...
<h3>Typing Swahili in Arabic script</h3>

<!-- Section tabs -->
<ul class="tabs left">
<li><a href="#intro">Introduction</a></li>
<li><a href="#access">Accessing the keyboard</a></li>
<li><a href="#usage">Using the keyboard</a></li>
<!-- <li><a href="#changing">Changing the layout</a></li> -->
...
include("keyboard_intro.php");
include("keyboard_access.php");
include("keyboard_usage.php");
// include("keyboard_changing.php");
include("keyboard_fonts.php");
