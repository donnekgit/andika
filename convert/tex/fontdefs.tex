...
\setmainfont[Ligatures=TeX]{Charis SIL}  % Set the default font for the document. = \setdefaultfont
...
\newcommand\Abig[1]{{\fontspec[Script=Arabic, Scale=10]{Scheherazade}\RLE{#1}}}  % Really big font for titles.
...
\newcommand\MS[1]{{\fontspec[Scale=0.7]{Liberation Serif Italic}#1}}  % English translation layer -- coloured grey, slightly less than normal size.
...
\newcommand\Em[1]{{\fontspec[Color=999999]{Charis SIL Italic}#1}} % Emendations -- coloured light grey, italics.

\newcommand\OLTst[1]{{\fontspec[Color=333333, Scale=1]{Linux Biolinum O}#1}}  % Standard spelling -- normal size.

\newcommand\OLTcl[1]{{\fontspec[Scale=0.9]{Charis SIL}#1}}  % Close spelling -- coloured green, slightly less than normal size.
...
% For  more information see the documentation for xcolor (https://ctan.org/pkg/xcolor; http://www.ukern.de/tex/xcolor.html).  The following color names are predefined: red, green, blue, cyan, magenta, yellow, black, gray, white, darkgray, lightgray, brown, lime, olive, orange, pink, purple, teal, violet.
