...
if (file_exists("convert/inputs/{$poem}_title.tex"))  // Call a title file specific to this poem if it exists ....
{
    $title=file_get_contents("convert/inputs/{$poem}_title.tex");
}
