...
<h3>Convert Roman script to Arabic script</h3>

<!-- Section tabs -->
<ul class="tabs left">
<li><a href="#intro">Introduction</a></li>
<li><a href="#box">Convert text</a></li>
<li><a href="#test">Samples for testing</a></li>
<li><a href="#webpage">Convert a webpage</a></li>
</ul>

<?php

//Bring in the content for each tab.
include("rom_ar_intro.php");
include("rom_ar_box.php");
include("rom_ar_test.php");
include("rom_ar_webpage.php");
