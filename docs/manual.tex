...
\section{Command-line converters}

Cutting and pasting does not make sense for long documents, or where there are a number of documents that need to be converted.  \textbf{Andika!} therefore includes a command-line converter which will act directly on the document, provided it is laid out in a particular format.
