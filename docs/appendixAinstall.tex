...
Download an Ubuntu iso from:
http://www.ubuntu.com/download/desktop
Ubuntu 14.04.1 LTS, 64-bit
and save it somewhere (it's about 960Mb).
...
Click Next.
Set 1024Mb (or 1500Mb if you have 3Gb or more of memory) as the memory amount. 
(Your IT guy set only 512Mb here.)
Click Next.
Tick "Create a virtual harddrive now"
Click Next.
Tick VDI.
Click Next.
Tick "Dynamically allocated"
Click Next.
Set 40Gb as the virtual hard drive size. (Your IT guy set only 8Gb here, which 
was OK sometime in the 90s.  I don't know why Oracle sets that as a default.)
Click Create.
Click the new Andika entry in the left-hand pane so that it is highlighted.
Click the icon for Start.
You will be asked to select a startup disk
Click the little folder to the right of the textbox to navigate to wherever 
you stored the Ubuntu iso.
Click OK.
Click Start.
The Ubuntu will load onto your virtual drive - it will take a couple of 
minutes.
Click "Install Ubuntu".
Click through the screens, accepting the defaults.
At the end, about 20 minutes, you should have a new Unity desktop, and you can 
go through Appendix A again.
You can do this and if it doesn't go right just delete the virtual machine, so 
it's quite an easy way of experimenting.
...
Click the \textbf{System Settings} icon in the Launcher, or click the system icon in the top right-hand corner and select \textbf{System Settings}.
