...
\multicolumn{2}{r}{\Swa{wamenatiya kaumu * na wana wa majirani}} & \Swa{2e/f} \\* 
...
\multicolumn{2}{r}{\Swa{nizee wanasiyasa * na ziongozi wa dini}} & \Swa{3e/f} \\* 
...
\multicolumn{2}{r}{\Swa{mafundi wa kila fani * na mashujaa wa zita}} & \Swa{3g/h} \\* 
...
\Tr{piya mwengo 'ath}\In{u}\Tr{māni} & \Tr{nḏimi māmāke muyāka} & \\* 
...
\multicolumn{2}{r}{\Swa{ndipo takapo kweleya * nikwambiyao mwendani}} & \Swa{5c/d} \\* 
...
\multicolumn{2}{r}{\Swa{ni t'ungo zimesaliya * na hazifi asilani}} & \Swa{5e/f} \\* 
...
\multicolumn{2}{r}{\Swa{na Malenga\footnote{The Bard of Mambasa refers to Ustadh Ahmad Nassir Juma Bhalo, see Chiraghdin (1971).
} wa Mvita * na pia Chiraghudini\footnote{Shihabdin Chiraghdin (1934-1976). See the biography by his daughter Latifa Chiraghdin which came out in 2012.}}} & \Swa{6a/b} \\* 
...
\multicolumn{2}{r}{\Swa{nyayo ulizifuata * hawakukiri uduni}} & \Swa{6c/d} \\* 
...
} huteta * lakini hufaliyani}} & \Swa{6e/f} \\* 
...
\multicolumn{2}{r}{\Swa{lakini mumenipuuza * mumeitoa fuoni}} & \Swa{7c/d} \\* 
...
\multicolumn{2}{r}{\Swa{huliya kisikitika * changaliya jaridani}} & \Swa{8a/b} \\* 
...
\multicolumn{2}{r}{\Swa{wengi hawatoki pwani * licha kuwa mbwa Mvita}} & \Swa{8g/h} \\* 
...
\multicolumn{2}{r}{\Swa{angalia na zitabu * zisomeshwao shuleni}} & \Swa{9a/b} \\* 
...
\multicolumn{2}{r}{\Swa{Njoroge\footnote{\textit{njoroge}: a name representing those who have their origins in the East African interior (the \textit{bara}).
} ndiye katibu * ashishiyeo sukani}} & \Swa{9e/f} \\* 
...
\multicolumn{2}{r}{\Swa{Charo\footnote{\textit{charo}: a name representing those who have their origins in the coastal hinterland (the \textit{nyika}).
} na wake wendani * nao nyuma hufuata}} & \Swa{9g/h} \\* 
...
\multicolumn{2}{r}{\Swa{huona utungu mnuu * kuwa nyinyi siwaoni}} & \Swa{10c/d} \\* 
...
\multicolumn{2}{r}{\Swa{na huziuma zitani\footnote{These words echo the words of the {\FN{Inkishafi}}: ``wakauma zanda na kuiyuta''. Readers unfamiliar with this Swahili gesture of regret could consult Eastman and Omar (1985).
} * lakini nitende nini}} & \Swa{10e/f} \\* 
...
\multicolumn{2}{r}{\Swa{na huliya kwa matozi * changaliya mitihani}} & \Swa{11a/b} \\* 
...
\multicolumn{2}{r}{\Swa{wanafundi wa Kibwezi * na wa Kisumu\footnote{Kibwezi and Kisumu are places in the East African interior.
} ziwani\footnote{The lake is Lake Nyanza, also known as Lake Victoria.}}} & \Swa{11c/d} \\* 
...
\multicolumn{2}{r}{\Swa{ndiwo wanao barizi * waliyoko kileleni}} & \Swa{11e/f} \\* 
...
\multicolumn{2}{r}{\Swa{mulotoka kwetu pwani * muko tini hukokota\footnote{Over the years young people on Lamu Island (and indeed elsewhere in northern Swahililand) have received a raw deal in their primary and secondary education. They have `lagged far behind' their counterparts
...
\multicolumn{2}{r}{\Swa{lau Muyaka tarudi * ae tena duniyani}} & \Swa{14a/b} \\* 
...
\multicolumn{2}{r}{\Swa{nyote mwende gerezani * kwa hatiya kuwapata}} & \Swa{14g/h} \\* 
...
\multicolumn{2}{r}{\Swa{hamuna lakuwakera * kuwa hamunithamini}} & \Swa{15c/d} \\* 
...
\multicolumn{2}{r}{\Swa{hipijwa tekendiani * na kila mwenye kupita}} & \Swa{15g/h} \\* 
